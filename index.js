...
*/
function createMenuIteams(itemName, itemPrice, itemCat) {
  return {
    name: itemName,
    price: itemPrice,
    category: itemCat,
...
console.log(createMenuItem('icedCoffee', 2, 'Breakfast'));
console.log(createMenuItem('icedTea', 2, 'Lunch'));
...
console.log(addReview(reviews, 'Dari', '4', 'I love this restaraunt'));
